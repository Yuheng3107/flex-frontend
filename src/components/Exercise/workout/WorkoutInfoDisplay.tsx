  ...
  return (
    <>
      <section id="top-section" className="relative h-1/4">
        <div
          id="workout-info"
          className="text-white z-20 absolute flex flex-col justify-end h-full p-3"
        >
          <p id="workout-name" className="text-xl font-semibold">
            {exerciseRegime.name}
          </p>
          <p className="text-sm">
            <span id="workout-duration"></span>
            <span id="exercise-count">
              {exerciseRegime.exercises.length} exercises
            </span>
          </p>
        </div>
        <img
          id="bg-banner"
          alt="banner image"
          src={backend.concat(exerciseRegime.media)}
              ...
              <IonItem key={index}>
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-600">
                    {exerciseRegime.exercises[index].reps.rep_count} reps
                  </p>
                </div>
