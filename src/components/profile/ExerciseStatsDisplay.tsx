    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="text-4xl font-bold mt-3 mb-1 z-10">
            {exerciseStats?.favorite_exercise?.exercise === null
              ? "None"
              : exercises[exerciseStats?.favorite_exercise?.exercise]}
          </span>
          <div className="z-10">
            <span className="text-lg font-semibold leading-3">
              {exerciseStats?.favorite_exercise?.total_reps
                ? exerciseStats?.favorite_exercise?.total_reps
                : "0"}
            </span>
          ...
          <div className="z-10">
            <span className="text-lg font-semibold">
              {exerciseStats.favorite_exercise.perfect_reps
                ? Math.round(
                    (exerciseStats?.favorite_exercise?.perfect_reps /
                      exerciseStats?.favorite_exercise?.total_reps) *
                      100
          ...
          <div className=" absolute w-full h-full left-0 top-0 bg-gradient-to-r from-gray-900 z-0"></div>
        </div>
      ...
      <div className="flex flex-row justify-evenly mt-2">
        ...
        >
          ...
          <span className="text-2xl">
            {exerciseStats?.favorite_exercise_regime?.name === null
              ? "None"
              : exerciseStats?.favorite_exercise_regime?.name}
          </span>
          <div>
            <span className="text-sm font-semibold">
              {exerciseStats?.favorite_exercise_regime?.times_completed === null
                ? "0"
                : exerciseStats?.favorite_exercise_regime?.times_completed}
            </span>
