      ...
      <aside>
        <ul>
          {communitiesData.map((item) => (
            <li
              key={item.id}
              className="flex flex-row justify-between h-12 item-center border-b border-b-stone-600"
            >
              <div className="name-and-photo flex flex-row h-full items-center ml-2">
                <img
                  ...
                  src="https://images.unsplash.com/photo-1580692475446-c2fabbbbf835?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80"
                ></img>
